...
#data = pd.read_csv('output_a_P6_v2/bbc/P6_cnavizout.tsv', sep='\t')
#data = pd.read_csv('output_HP6_v1/bbc/edited/p6_20211121173320.tsv', sep='\t')
#data = pd.read_csv('output_HP6_v1/bbc/edited/p10_20211121182159.tsv', sep='\t')
#data = pd.read_csv('final-nov10/P6_20211110110956.tsv', sep='\t')
#data = pd.read_csv('P6_v3/P6_20211110025147.tsv', sep='\t')
#data = pd.read_csv('P6_clusteredit/hatchet_P6_v2.tsv', sep='\t')
#data = pd.read_csv('hatchet_P6_nov3/P6_20211103012834.tsv', sep='\t')
#data = pd.read_csv('https://github.com/raphael-group/hatchet-paper/raw/master/cancer/Kim2018/KTN129/results/best.bbc.ucn.gz', sep='\t')
